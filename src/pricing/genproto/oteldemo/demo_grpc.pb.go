...
const (
	PricingService_GetProductPrice_FullMethodName   = "/oteldemo.PricingService/GetProductPrice"
	PricingService_GetBulkPrices_FullMethodName     = "/oteldemo.PricingService/GetBulkPrices"
	PricingService_CalculateDiscount_FullMethodName = "/oteldemo.PricingService/CalculateDiscount"
)
...
type PricingServiceClient interface {
	...
	GetBulkPrices(ctx context.Context, in *GetBulkPricesRequest, opts ...grpc.CallOption) (*GetBulkPricesResponse, error)
...
func (c *pricingServiceClient) GetProductPrice(ctx context.Context, in *GetProductPriceRequest, opts ...grpc.CallOption) (*GetProductPriceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProductPriceResponse)
	err := c.cc.Invoke(ctx, PricingService_GetProductPrice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pricingServiceClient) GetBulkPrices(ctx context.Context, in *GetBulkPricesRequest, opts ...grpc.CallOption) (*GetBulkPricesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBulkPricesResponse)
	err := c.cc.Invoke(ctx, PricingService_GetBulkPrices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PricingServiceServer interface {
	...
	GetBulkPrices(context.Context, *GetBulkPricesRequest) (*GetBulkPricesResponse, error)
...
func (UnimplementedPricingServiceServer) GetProductPrice(context.Context, *GetProductPriceRequest) (*GetProductPriceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProductPrice not implemented")
}
func (UnimplementedPricingServiceServer) GetBulkPrices(context.Context, *GetBulkPricesRequest) (*GetBulkPricesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBulkPrices not implemented")
}
...
func _PricingService_GetProductPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProductPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PricingServiceServer).GetProductPrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PricingService_GetProductPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PricingServiceServer).GetProductPrice(ctx, req.(*GetProductPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PricingService_GetBulkPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBulkPricesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PricingServiceServer).GetBulkPrices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PricingService_GetBulkPrices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PricingServiceServer).GetBulkPrices(ctx, req.(*GetBulkPricesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PricingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "oteldemo.PricingService",
	HandlerType: (*PricingServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetProductPrice",
			Handler:    _PricingService_GetProductPrice_Handler,
		},
		{
			MethodName: "GetBulkPrices",
			Handler:    _PricingService_GetBulkPrices_Handler,
		},
		{
