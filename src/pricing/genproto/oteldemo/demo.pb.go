...
func (x *GetProductPriceRequest) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *GetProductPriceRequest) GetCurrencyCode() string {
	if x != nil {
		return x.CurrencyCode
	}
	return ""
...
func (x *GetProductPriceRequest) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type ProductPrice struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	ProductId       string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	BasePrice       *Money                 `protobuf:"bytes,2,opt,name=base_price,json=basePrice,proto3" json:"base_price,omitempty"`
	DiscountedPrice *Money                 `protobuf:"bytes,3,opt,name=discounted_price,json=discountedPrice,proto3" json:"discounted_price,omitempty"`
...
func (x *ProductPrice) GetBasePrice() *Money {
	if x != nil {
		return x.BasePrice
	}
	return nil
...
func (x *ProductPrice) GetDiscountedPrice() *Money {
	if x != nil {
...
func (x *ProductPrice) GetDiscountPercent() float64 {
	if x != nil {
...
func (x *ProductPrice) GetCurrencyCode() string {
	if x != nil {
		return x.CurrencyCode
	}
	return ""
...
type GetProductPriceResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Price         *ProductPrice          `protobuf:"bytes,1,opt,name=price,proto3" json:"price,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetProductPriceResponse) GetPrice() *ProductPrice {
	if x != nil {
		return x.Price
	}
	return nil
...
type GetBulkPricesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProductIds    []string               `protobuf:"bytes,1,rep,name=product_ids,json=productIds,proto3" json:"product_ids,omitempty"`
	CurrencyCode  string                 `protobuf:"bytes,2,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *GetBulkPricesRequest) Reset() {
	*x = GetBulkPricesRequest{}
	mi := &file_demo_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBulkPricesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBulkPricesRequest) ProtoMessage() {}

func (x *GetBulkPricesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBulkPricesRequest.ProtoReflect.Descriptor instead.
func (*GetBulkPricesRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{53}
}

func (x *GetBulkPricesRequest) GetProductIds() []string {
	if x != nil {
		return x.ProductIds
	}
	return nil
...
func (x *GetBulkPricesRequest) GetCurrencyCode() string {
	if x != nil {
		return x.CurrencyCode
	}
	return ""
...
type GetBulkPricesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetBulkPricesResponse) Reset() {
	*x = GetBulkPricesResponse{}
	mi := &file_demo_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBulkPricesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBulkPricesResponse) ProtoMessage() {}

func (x *GetBulkPricesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBulkPricesResponse.ProtoReflect.Descriptor instead.
func (*GetBulkPricesResponse) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{54}
}

func (x *GetBulkPricesResponse) GetPrices() []*ProductPrice {
	if x != nil {
		return x.Prices
	}
	return nil
...
func (x *CalculateDiscountRequest) GetItems() []*CartItem {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *CalculateDiscountRequest) GetPromoCode() string {
	if x != nil {
		return x.PromoCode
	}
	return ""
...
type CalculateDiscountResponse struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	TotalBeforeDiscount *Money                 `protobuf:"bytes,1,opt,name=total_before_discount,json=totalBeforeDiscount,proto3" json:"total_before_discount,omitempty"`
	TotalAfterDiscount  *Money                 `protobuf:"bytes,2,opt,name=total_after_discount,json=totalAfterDiscount,proto3" json:"total_after_discount,omitempty"`
	DiscountPercent     float64                `protobuf:"fixed64,3,opt,name=discount_percent,json=discountPercent,proto3" json:"discount_percent,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CalculateDiscountResponse) GetTotalBeforeDiscount() *Money {
	if x != nil {
		return x.TotalBeforeDiscount
	}
	return nil
}

func (x *CalculateDiscountResponse) GetTotalAfterDiscount() *Money {
	if x != nil {
		return x.TotalAfterDiscount
	}
	return nil
}

func (x *CalculateDiscountResponse) GetDiscountPercent() float64 {
	if x != nil {
		return x.DiscountPercent
	}
	return 0
...
const file_demo_proto_rawDesc = "" +
	...
	"\x12DeleteFlagResponse\"x\n" +
	"\x16GetProductPriceRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12#\n" +
	"\rcurrency_code\x18\x02 \x01(\tR\fcurrencyCode\x12\x1a\n" +
	"\bquantity\x18\x03 \x01(\x05R\bquantity\"\xe9\x01\n" +
	"\fProductPrice\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12.\n" +
	"\n" +
	"base_price\x18\x02 \x01(\v2\x0f.oteldemo.MoneyR\tbasePrice\x12:\n" +
	"\x10discounted_price\x18\x03 \x01(\v2\x0f.oteldemo.MoneyR\x0fdiscountedPrice\x12)\n" +
	"\x10discount_percent\x18\x04 \x01(\x01R\x0fdiscountPercent\x12#\n" +
	"\rcurrency_code\x18\x05 \x01(\tR\fcurrencyCode\"G\n" +
	"\x17GetProductPriceResponse\x12,\n" +
	"\x05price\x18\x01 \x01(\v2\x16.oteldemo.ProductPriceR\x05price\"\\\n" +
	"\x14GetBulkPricesRequest\x12\x1f\n" +
	"\vproduct_ids\x18\x01 \x03(\tR\n" +
	"productIds\x12#\n" +
	"\rcurrency_code\x18\x02 \x01(\tR\fcurrencyCode\"G\n" +
	"\x15GetBulkPricesResponse\x12.\n" +
	"\x06prices\x18\x01 \x03(\v2\x16.oteldemo.ProductPriceR\x06prices\"c\n" +
	"\x18CalculateDiscountRequest\x12(\n" +
	"\x05items\x18\x01 \x03(\v2\x12.oteldemo.CartItemR\x05items\x12\x1d\n" +
	"\n" +
	"promo_code\x18\x02 \x01(\tR\tpromoCode\"\xce\x01\n" +
	"\x19CalculateDiscountResponse\x12C\n" +
	"\x15total_before_discount\x18\x01 \x01(\v2\x0f.oteldemo.MoneyR\x13totalBeforeDiscount\x12A\n" +
	"\x14total_after_discount\x18\x02 \x01(\v2\x0f.oteldemo.MoneyR\x12totalAfterDiscount\x12)\n" +
	"\x10discount_percent\x18\x03 \x01(\x01R\x0fdiscountPercent2\xb8\x01\n" +
	"\vCartService\x126\n" +
	...
	"\n" +
	"DeleteFlag\x12\x1b.oteldemo.DeleteFlagRequest\x1a\x1c.oteldemo.DeleteFlagResponse\"\x002\x98\x02\n" +
	"\x0ePricingService\x12V\n" +
	"\x0fGetProductPrice\x12 .oteldemo.GetProductPriceRequest\x1a!.oteldemo.GetProductPriceResponse\x12P\n" +
	"\rGetBulkPrices\x12\x1e.oteldemo.GetBulkPricesRequest\x1a\x1f.oteldemo.GetBulkPricesResponse\x12\\\n" +
	"\x11CalculateDiscount\x12\".oteldemo.CalculateDiscountRequest\x1a#.oteldemo.CalculateDiscountResponseB\x13Z\x11genproto/oteldemob\x06proto3"
...
var file_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_demo_proto_goTypes = []any{
	...
	(*GetProductPriceRequest)(nil),               // 50: oteldemo.GetProductPriceRequest
	(*ProductPrice)(nil),                         // 51: oteldemo.ProductPrice
	(*GetProductPriceResponse)(nil),              // 52: oteldemo.GetProductPriceResponse
	(*GetBulkPricesRequest)(nil),                 // 53: oteldemo.GetBulkPricesRequest
	(*GetBulkPricesResponse)(nil),                // 54: oteldemo.GetBulkPricesResponse
	(*CalculateDiscountRequest)(nil),             // 55: oteldemo.CalculateDiscountRequest
	(*CalculateDiscountResponse)(nil),            // 56: oteldemo.CalculateDiscountResponse
}
var file_demo_proto_depIdxs = []int32{
	...
	25, // 27: oteldemo.ProductPrice.base_price:type_name -> oteldemo.Money
	25, // 28: oteldemo.ProductPrice.discounted_price:type_name -> oteldemo.Money
	51, // 29: oteldemo.GetProductPriceResponse.price:type_name -> oteldemo.ProductPrice
	51, // 30: oteldemo.GetBulkPricesResponse.prices:type_name -> oteldemo.ProductPrice
	0,  // 31: oteldemo.CalculateDiscountRequest.items:type_name -> oteldemo.CartItem
	25, // 32: oteldemo.CalculateDiscountResponse.total_before_discount:type_name -> oteldemo.Money
	25, // 33: oteldemo.CalculateDiscountResponse.total_after_discount:type_name -> oteldemo.Money
	...
	33, // 49: oteldemo.EmailService.SendOrderConfirmation:input_type -> oteldemo.SendOrderConfirmationRequest
	34, // 50: oteldemo.CheckoutService.PlaceOrder:input_type -> oteldemo.PlaceOrderRequest
	36, // 51: oteldemo.AdService.GetAds:input_type -> oteldemo.AdRequest
	40, // 52: oteldemo.FeatureFlagService.GetFlag:input_type -> oteldemo.GetFlagRequest
	42, // 53: oteldemo.FeatureFlagService.CreateFlag:input_type -> oteldemo.CreateFlagRequest
	44, // 54: oteldemo.FeatureFlagService.UpdateFlag:input_type -> oteldemo.UpdateFlagRequest
	46, // 55: oteldemo.FeatureFlagService.ListFlags:input_type -> oteldemo.ListFlagsRequest
	48, // 56: oteldemo.FeatureFlagService.DeleteFlag:input_type -> oteldemo.DeleteFlagRequest
	50, // 57: oteldemo.PricingService.GetProductPrice:input_type -> oteldemo.GetProductPriceRequest
	53, // 58: oteldemo.PricingService.GetBulkPrices:input_type -> oteldemo.GetBulkPricesRequest
	55, // 59: oteldemo.PricingService.CalculateDiscount:input_type -> oteldemo.CalculateDiscountRequest
	...
	19, // 69: oteldemo.ProductReviewService.AskProductAIAssistant:output_type -> oteldemo.AskProductAIAssistantResponse
	21, // 70: oteldemo.ShippingService.GetQuote:output_type -> oteldemo.GetQuoteResponse
	23, // 71: oteldemo.ShippingService.ShipOrder:output_type -> oteldemo.ShipOrderResponse
	26, // 72: oteldemo.CurrencyService.GetSupportedCurrencies:output_type -> oteldemo.GetSupportedCurrenciesResponse
	25, // 73: oteldemo.CurrencyService.Convert:output_type -> oteldemo.Money
	30, // 74: oteldemo.PaymentService.Charge:output_type -> oteldemo.ChargeResponse
	5,  // 75: oteldemo.EmailService.SendOrderConfirmation:output_type -> oteldemo.Empty
	35, // 76: oteldemo.CheckoutService.PlaceOrder:output_type -> oteldemo.PlaceOrderResponse
	37, // 77: oteldemo.AdService.GetAds:output_type -> oteldemo.AdResponse
	41, // 78: oteldemo.FeatureFlagService.GetFlag:output_type -> oteldemo.GetFlagResponse
	43, // 79: oteldemo.FeatureFlagService.CreateFlag:output_type -> oteldemo.CreateFlagResponse
	45, // 80: oteldemo.FeatureFlagService.UpdateFlag:output_type -> oteldemo.UpdateFlagResponse
	47, // 81: oteldemo.FeatureFlagService.ListFlags:output_type -> oteldemo.ListFlagsResponse
	49, // 82: oteldemo.FeatureFlagService.DeleteFlag:output_type -> oteldemo.DeleteFlagResponse
	52, // 83: oteldemo.PricingService.GetProductPrice:output_type -> oteldemo.GetProductPriceResponse
	54, // 84: oteldemo.PricingService.GetBulkPrices:output_type -> oteldemo.GetBulkPricesResponse
	56, // 85: oteldemo.PricingService.CalculateDiscount:output_type -> oteldemo.CalculateDiscountResponse
